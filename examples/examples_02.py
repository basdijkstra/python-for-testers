...
def this_is_a_function_with_multiple_parameters(parameter_one, parameter_two):
    print(
        "Parameter one is " + parameter_one + " and parameter two is " + parameter_two
    )
...
def this_is_a_function_with_a_default_value_for_a_parameter(
    parameter_one, parameter_two="two"
):
    print(
        "Parameter one is " + parameter_one + " and parameter two is " + parameter_two
    )
